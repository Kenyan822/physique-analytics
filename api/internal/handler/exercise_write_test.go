...
func TestCreateExercise_201と作成した種目を返す(t *testing.T) {
	...
	srv := handler.NewRouter(handler.New(stubPinger{}, stub, &stubWorkouts{}, &stubTemplates{}, &stubSync{}, &stubTransfer{}))
...
func TestCreateExercise_名前が空なら400(t *testing.T) {
	...
	srv := handler.NewRouter(handler.New(stubPinger{}, &stubExercises{}, &stubWorkouts{}, &stubTemplates{}, &stubSync{}, &stubTransfer{}))
