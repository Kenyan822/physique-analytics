...
func newTestServer(t *testing.T, p handler.Pinger) http.Handler {
	t.Helper()
	return handler.NewRouter(handler.New(p, &stubExercises{}, &stubWorkouts{}, &stubTemplates{}, &stubSync{}, &stubTransfer{}, &stubBody{}, &stubMeals{}, &stubPlan{}, &stubSeries{}, &stubMealSets{}, &stubContests{}, &stubBlood{}, &stubEstimator{}))
}
