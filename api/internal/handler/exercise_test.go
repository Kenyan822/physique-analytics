...
func TestListExercises_一覧を返す(t *testing.T) {
	...
	handler.NewRouter(handler.New(stubPinger{}, stub, &stubWorkouts{}, &stubTemplates{}, &stubSync{}, &stubTransfer{}, &stubBody{}, &stubMeals{})).
...
func TestListExercises_クエリパラメータが絞り込み条件に渡る(t *testing.T) {
	...
	stub := &stubExercises{}
	rec := httptest.NewRecorder()
	handler.NewRouter(handler.New(stubPinger{}, stub, &stubWorkouts{}, &stubTemplates{}, &stubSync{}, &stubTransfer{}, &stubBody{}, &stubMeals{})).ServeHTTP(rec,
...
func TestGetExercise_UUIDでないIDは400(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	handler.NewRouter(handler.New(stubPinger{}, &stubExercises{}, &stubWorkouts{}, &stubTemplates{}, &stubSync{}, &stubTransfer{}, &stubBody{}, &stubMeals{})).ServeHTTP(rec,
